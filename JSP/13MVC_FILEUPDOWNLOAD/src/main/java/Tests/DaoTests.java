...
class DaoTests {
	...
	void test6() throws Exception {
		BookReplyDaoImpl.getInstance().insert(new BookReplyDto(-1,"CDG000000001","sssss", "asd", LocalDateTime.now()));
		}
	
	@Test
	void test7() throws Exception {
		BookReplyDaoImpl.getInstance().selectAll(null).forEach(System.out::println);
	}
}
