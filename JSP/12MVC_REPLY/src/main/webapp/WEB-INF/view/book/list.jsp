				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td><a
								href="${pageContext.request.contextPath}/book/read?bookCode=<%=dto.getBookCode() %>&pageno=<%=pageDto.getCriteria().getPageno() %>"><%=dto.getBookName()%></a></td>
