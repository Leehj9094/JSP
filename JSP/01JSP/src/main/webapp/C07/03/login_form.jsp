<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	if(session.getAttribute("isAuth")!=null){
		out.println("<script>alert('이미 로그인 상태입니다.');location.href='./main'</script>");
...
<body>
	...
	<h1>LOGIN FORM</h1>
	<div style="min-height:25px; font-size:.8rem; color:yellow">
	${param.message }
	</div>
	<form action="${pageContext.request.contextPath}/C07/03/login.jsp" method="post">
		...
		<div>
			...
			<input type="checkbox" id="pwSave" name="psSave" ${cookie.password != null ? 'checked' : '' } />
